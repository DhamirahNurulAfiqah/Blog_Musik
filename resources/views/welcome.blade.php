      ...
      <div class="row g-4">
        ...
        <div class="col-md-4">
          <div class="card h-100">
            <img src="{{ asset('images/img1.jpg') }}" class="card-img-top" alt="Musik Pop" />
            <div class="card-body">
            ...
            <div class="card-footer bg-white">
              <a href="/artikel1" class="card-link">Selengkapnya</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="card h-100">
            <img src="{{ asset('images/img2.jpg') }}" class="card-img-top" alt="Musik Klasik" />
            <div class="card-body">
            ...
            <div class="card-footer bg-white">
              <a href="/artikel2" class="card-link">Selengkapnya</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="card h-100">
            <img src="{{ asset('images/img3.jpg') }}" class="card-img-top" alt="Musik Rock" />
            <div class="card-body">
            ...
            <div class="card-footer bg-white">
              <a href="/artikel3" class="card-link">Selengkapnya</a>
            </div>
          </div>
        </div>
